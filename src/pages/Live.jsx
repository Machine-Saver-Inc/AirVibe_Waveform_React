    ...
    <div className="container">
      <header className="header">
        ...
        <div className="row">
          ...
          <select id="msg" className="select" value={file} onChange={(e) => setFile(e.target.value)}>
      ...
      <section className="card">
        ...
        <pre style={{
          marginTop: 10, background: "#10131a", padding: 12, borderRadius: 10,
          overflowX: "auto", border: "1px solid var(--ring)"
        }}>
